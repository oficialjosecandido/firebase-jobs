...
class allEmployeeSerializer(serializers.ModelSerializer):
    class Meta:
        model = Employees
        fields = ('EmployeeId', 'EmployeeName', 'Department', 'PhotoFileName', 'DateOfJoining', 'Email', 'Primary_Tech', 'Location', 'Level', 'Views',
                  'Expected_Sallary', 'Working', 'Bio', 'Remote', 'Featured')


class EmployeeSerializer(serializers.ModelSerializer):
    class Meta:
        model = Employees
        fields = ('EmployeeId', 'EmployeeName', 'Department', 'PhotoFileName', 'DateOfJoining', 'Email', 'Primary_Tech', 'Level', 'Location', 'Expected_Sallary', 'Working', 'Bio', 'Remote',
                  ...
                  'language3_level', 'language4', 'language4_level', 'language5', 'language5_level', 'youtube', 'linkedin', 'github', 'portfolio', 'Featured', 'driverLicense', 'notes',
...
class addEmployeeSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ('EmployeeName', 'Department', 'PhotoFileName', 'Primary_Tech', 'Location',
                  'Bio', 'Email', 'Working', 'youtube', 'linkedin', 'github', 'portfolio', 'notes')
...
class updateSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ('EmployeeId', 'Email', 'Location', 'Expected_Sallary', 'Working', 'Bio', 'WorkExperience1_title', 'WorkExperience1_startYear', 'WorkExperience1_startMonth',
                  ...
                  'github', 'linkedin', 'youtube', 'portfolio', 'driverLicense', 'notes',
                  'country1', 'country2', 'country3', 'country4', 'country5', 'country6', 'country7', 'country8', 'country9', 'country10')
